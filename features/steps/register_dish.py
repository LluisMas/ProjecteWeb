...
def step_impl(context, restaurant_name, username):
    ...
    from distributors.models import Dish
...
def step_impl(context, restaurant_name):
    ...
    restaurant = Restaurant.objects.get(name=restaurant_name)
    for row in context.table:
        context.browser.visit(context.get_url('distributors:dish_create', restaurant.pk))
        if context.browser.url == context.get_url('distributors:dish_create', restaurant.pk):
...
def step_impl(context):
    ...
    # context.browser.visit(context.get_url('distributors:dish_edit', dish.pk))
    form = context.browser.find_by_tag('form').first
