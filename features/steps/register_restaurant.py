...
def step_impl(context, username):
    ...
    from distributors.models import Restaurant
...
def step_impl(context):
    for row in context.table:
        context.browser.visit(context.get_url('distributors:restaurant_create'))
        if context.browser.url == context.get_url('distributors:restaurant_create'):
...
def step_impl(context, name):
    ...
    context.browser.visit(context.get_url('distributors:restaurant_edit', restaurant.pk))
    if context.browser.url == context.get_url('distributors:restaurant_edit', restaurant.pk)\
